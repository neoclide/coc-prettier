...
export const RESTART_TO_ENABLE =
  "To enable or disable prettier after changing the `enable` setting, you must restart coc.nvim by :CocRestart"
export const USING_BUNDLED_PRETTIER = "Using bundled version of prettier."
export const EXTENSION_DISABLED =
  "Extension is disabled. No formatters will be registered. To enable, change the `prettier.enable` to `true` and restart coc.nvim by :CocRestart."
